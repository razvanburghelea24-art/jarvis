...
_TOOL_TO_CAPABILITY: dict[str, str] = {
    ...
    "Discord.edit_message": "discord.send",
    "Discord.delete_message": "discord.send",
    "Discord.read_channel": "discord.read",
    "Discord.read_message": "discord.read",
    "Discord.list_channels": "discord.read",
    "Discord.timeout_user": "discord.send",
    "Discord.kick_user": "discord.send",
    "Discord.ban_user": "discord.send",
    "Framework.run": "framework.execute",
    "Framework.server_status": "framework.read",
    "Framework.players": "framework.read",
    "Framework.world_time": "framework.read",
    "Framework.weather": "framework.read",
    "Framework.server_info": "framework.read",
    "Framework.health": "framework.read",
    "Framework.metrics": "framework.read",
    "Framework.broadcast": "framework.execute",
    "Framework.time_set": "framework.execute",
    "Framework.weather_set": "framework.execute",
    "Framework.heal": "framework.execute",
    "Framework.grow": "framework.execute",
    "Framework.teleport": "framework.execute",
    "Framework.kick": "framework.execute",
    "Framework.ban": "framework.execute",
    "Framework.points": "framework.execute",
    "Framework.economy": "framework.execute",
    "Railway.deploy": "railway.deploy",
    "Railway.restart_service": "railway.deploy",
    "Railway.rollback": "railway.deploy",
    "Railway.set_variable": "railway.deploy",
    "Railway.delete_variable": "railway.deploy",
    "Railway.project_status": "railway.read",
    "Railway.service_status": "railway.read",
    "Railway.deployment_status": "railway.read",
    "Railway.list_services": "railway.read",
    "Railway.list_deployments": "railway.read",
    "Railway.logs": "railway.read",
    "Railway.environment_info": "railway.read",
    "n8n.execute_workflow": "n8n.execute",
    "n8n.activate_workflow": "n8n.execute",
    "n8n.deactivate_workflow": "n8n.execute",
    "n8n.cancel_execution": "n8n.execute",
    "n8n.workflow_status": "n8n.read",
    "n8n.list_workflows": "n8n.read",
    "n8n.execution_status": "n8n.read",
    "n8n.execution_logs": "n8n.read",
    "n8n.workflow_info": "n8n.read",
